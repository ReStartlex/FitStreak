  ...
  const plans = [
    {
      ...
      features: locale === "ru"
        ? [
            ...
            "Дневная цель и streak",
            "Простые публичные челленджи",
            "Базовая статистика",
            "Один тип напоминаний",
          ]
        : [
            "Basic activity tracking",
            "Daily goal and streak",
            "Simple public challenges",
            "Basic statistics",
            "One reminder type",
          ],
    },
    {
      ...
      features: locale === "ru"
        ? [
            ...
            "Персональные челленджи и адаптивные цели",
            "Дуэли с друзьями 1-на-1",
            "Smart reminders на любой режим",
            "Эксклюзивные бейджи и уровни",
            "Pro leaderboard insights",
          ]
        : [
            "Everything in Free",
            "Advanced analytics and period comparison",
            "Personal challenges and adaptive goals",
            "1-on-1 duels with friends",
            "Smart reminders in any mode",
    ...
    },
    {
      ...
      features: locale === "ru"
        ? [
            ...
            "Аналитика команды и лидерборды",
            "Private community-чаты",
            "Корпоративный режим (early access)",
          ]
        : [
            "Everything in Pro",
